...
namespace Alura.Estacionamento.Modelos
{
    public class Veiculo
    {
        ...
        public void AlterarDados(Veiculo veiculoAlterarDados)
        {
            this.Proprietario = veiculoAlterarDados.Proprietario;
            this.Cor = veiculoAlterarDados.Cor;
            this.Modelo = veiculoAlterarDados.Modelo;
        }
